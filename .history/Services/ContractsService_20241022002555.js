...
exports.getContracts = expressAsyncHandler(async (req, res) => {
 ...
 const sendNotifacations = notificationsToSend.forEach(async(notification) => {
...
console.log(sendNotifacations);
  ...
  res
    .status(201)
    .json({ results: getDoc.length, PaginateResult, data: getDoc , notifications:sendNotifacations });
});
