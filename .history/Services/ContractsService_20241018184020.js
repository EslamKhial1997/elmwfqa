...
exports.createContracts = expressAsyncHandler(async (req, res) => {
  ...
  const attorneyArray = JSON.parse(req.body.attorney);
  req.body.attorney = attorneyArray;
  // إنشاء العقد وحفظه
  const contracts = await createContractsModel.create(JSON.parse(req.body.attorney));
